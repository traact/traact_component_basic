...
#ifndef TRAACT_GUI_SRC_TRAACT_DEBUG_RUN_TRAACT_OPENGL_H_
#define TRAACT_GUI_SRC_TRAACT_DEBUG_RUN_TRAACT_OPENGL_H_
...
#endif //TRAACT_GUI_SRC_TRAACT_DEBUG_RUN_TRAACT_OPENGL_H_
