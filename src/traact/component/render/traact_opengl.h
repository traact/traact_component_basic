...
#ifndef TRAACT_COMPONENT_BASIC_SRC_TRAACT_COMPONENT_RENDER_TRAACT_OPENGL_H_
#define TRAACT_COMPONENT_BASIC_SRC_TRAACT_COMPONENT_RENDER_TRAACT_OPENGL_H_
...
#endif //TRAACT_COMPONENT_BASIC_SRC_TRAACT_COMPONENT_RENDER_TRAACT_OPENGL_H_
